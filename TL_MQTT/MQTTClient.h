...
public:
    ...
    // added by fkb
    // *****************************************
    Client(const Client& temp);
    Client& operator=(const Client& temp);
    //void operator=(const Client& temp);
    //******************************************
...
template<class Network, class Timer, int a, int MAX_MESSAGE_HANDLERS>
MQTT::Client<Network, Timer, a, MAX_MESSAGE_HANDLERS>::Client(const MQTT::Client<Network, Timer, a, MAX_MESSAGE_HANDLERS>& temp)  : ipstack(temp.ipstack), packetid(temp.packetid)
{
    this->command_timeout_ms = temp.command_timeout_ms;
    cleanSession();
}

template<class Network, class Timer, int a, int MAX_MESSAGE_HANDLERS>
MQTT::Client<Network, Timer, a, MAX_MESSAGE_HANDLERS>& MQTT::Client<Network, Timer, a, MAX_MESSAGE_HANDLERS>:: operator=(const MQTT::Client<Network, Timer, a, MAX_MESSAGE_HANDLERS>& temp)
{

    this->command_timeout_ms = temp.command_timeout_ms;
    this->ipstack = temp.ipstack;
    this->packetid = temp.packetid;
